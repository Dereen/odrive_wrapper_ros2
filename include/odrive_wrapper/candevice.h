...
#ifndef ODRIVE_WRAPPER_CAN_DEVICE_H
#define ODRIVE_WRAPPER_CAN_DEVICE_H
 ...
 */
    ...
    public:
        ...
        ~CanDevice() {
            if (this->active)
                close_connection(); // if connection is active, close socket
        };
...
#endif // ODRIVE_WRAPPER_CAN_DEVICE_H